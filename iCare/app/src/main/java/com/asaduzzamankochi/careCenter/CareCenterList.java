 ...
 */
public class CareCenterList extends ActionBarActivity {
    ...
    private ArrayAdapter<CareCenter> listAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewTitle.setText("List of Care Centers :");

        listView = (ListView) findViewById(R.id.listView);
        dbHelper = new DBHelper(CareCenterList.this);

        careCenters = dbHelper.showCareCenterList();

        if (careCenters.isEmpty()) {

            secondaryLayout.setVisibility(View.VISIBLE);
            mainLayout.setVisibility(View.GONE);
            btnAddNewFamily.setText("Add New Care Center");
            textView.setText("Care Center List is Empty!!");

        }
        //listAdapter = new ArrayAdapter<Employee>(this, android.R.layout.simple_list_item_1, doctorName);
        listAdapter = new ArrayAdapter<CareCenter>(this, R.layout.doctor_list_view_center, R.id.txtNameView, careCenters);
...
//        listView.setAdapter(new NameListViewAdapter(this,empName));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                int item = careCenters.get(position).getId();
                Intent intent = new Intent(CareCenterList.this, CareCenterInformation.class);
